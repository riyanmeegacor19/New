...
const ID: Dict = {
  ...
  hunt_empty: 'Masukkan IP target dan ketuk "Mulai Pencarian" untuk menemukan proxy yang cocok.',
...
const EN: Dict = {
  ...
  hunt_empty: 'Enter a target IP and tap "Start Search" to find matching proxies.',

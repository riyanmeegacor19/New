...
const ID: Dict = {
  ...
  hunt_empty: 'Pilih negara lalu ketuk "Mulai Pencarian" untuk berburu proxy residential nyata.',
...
const EN: Dict = {
  ...
  hunt_empty: 'Pick a country then tap "Start Search" to hunt real residential proxies.',
